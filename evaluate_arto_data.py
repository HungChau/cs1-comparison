        ...
        for b in range(0, 101):
            ...
            for c in range(0, 101):
                if a == 0 and b == 0 and c == 0:
                    break
                # print(a,b,c)
                f1_3, f1_5, f1_10, f1_15 = recommendation_combined("data/arto.examples_with_concepts.aggregated.csv", "data/arto.assignment.csv", a, b, c)
                if f1_3 > best_f1_3:
                    best_f1_3 = f1_3
                    alpha_best_3 = a
                    beta_best_3 = b
...
# DrawContour()
# recommendation("data/arto.examples_with_concepts.aggregated.csv", "data/arto.assignment.csv", 0, 1, 3)
